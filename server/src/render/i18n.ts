...
const MESSAGES: Record<string, Messages> = {
  en: {
    ...
    aboutShareblog: "About Flightstead",
  ...
  de: {
    ...
    aboutShareblog: "Über Flightstead",
  ...
  fr: {
    ...
    aboutShareblog: "À propos de Flightstead",
  ...
  es: {
    ...
    aboutShareblog: "Acerca de Flightstead",
  ...
  ja: {
    ...
    aboutShareblog: "Flightsteadについて",
    releaseHistory: "更新履歴",
